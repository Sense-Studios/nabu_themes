...
var GLRenderer = function( _settings ) {
  ...
  _self.width = video_width
  _self.height = video_height
  ...
  _self.init = function() {
    ...
    var bg_texture = THREE.ImageUtils.loadTexture('img/77a14d9991e181161dd5a46694608088.jpg')
    ...
    var noiseTexture = new THREE.ImageUtils.loadTexture( '/assets/nabu_themes/mixer/cloud.png' );
    noiseTexture.wrapS = noiseTexture.wrapT = THREE.RepeatWrapping;

    var waterTexture = new THREE.ImageUtils.loadTexture( '/assets/nabu_themes/mixer/water.jpg' );
...
// -----------------------------------------------------------------------------
  ...
  _self.update = function(){
    ...
    customUniforms2.alpha2.value = (Math.cos(c) + 1) / 2;
