...
function initScene() {
  ...
  var some_element = document.getElementById( 'label_figuur_1' );
  css_object = new THREE.CSS3DObject( some_element );
  css_object.position.x = -800;
  css_object.position.y = 300;
  css_object.position.z = -400;
  css_object.rotation.x = 0;
  css_object.rotation.y = 1;
  css_object.rotation.z = 0;
  css_object.doLookAt = false

  css_scene.add( css_object );
  cssObjects.push( css_object );

  var some_element = document.getElementById( 'label_figuur_2' );
  css_object = new THREE.CSS3DObject( some_element );
  css_object.position.x = 800;
  css_object.position.y = 200;
  css_object.position.z = -300;
  css_object.rotation.x = 0;
  css_object.rotation.y = -1;
  css_object.rotation.z = 0;
  css_object.doLookAt = false
  ...
  var some_element = document.getElementById( 'youtube_embed_test' );
  css_object = new THREE.CSS3DObject( some_element );
  css_object.position.x = 0;
  css_object.position.y = 200;
  css_object.position.z = 600;
  css_object.rotation.x = 0;
  css_object.rotation.y = 3.14;
  css_object.rotation.z = 0;
  css_object.doLookAt = false
...
function render() {
  ...
  try{
    if(useRift){
      ...
      for ( var obj in cssObjects ) { if (cssObjects[obj].doLookAt) cssObjects[obj].lookAt( camera.position ); };
    }
  } catch(e){
    console.log(e);
