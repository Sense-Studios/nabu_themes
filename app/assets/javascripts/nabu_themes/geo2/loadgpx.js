...
GPXParser.prototype.addTrackSegmentToMap = function(trackSegment, colour, width) {
    ...
    polyline.addListener('click', function(e) { holder = this; console.log("polyline am: ", this, e) } );
    // s = holder.getPath().b[0]
    // holder.getPath().b[0]
    polyline.setMap(map);
}
...
GPXParser.prototype.addTrackToMap = function(track, colour, width) {
    ...
    console.log("add trkseg", segments.length)
...
GPXParser.prototype.centerAndZoom = function(trackSegment) {
    ...
    //map_center = new google.maps.LatLng(centerlat, centerlon)
